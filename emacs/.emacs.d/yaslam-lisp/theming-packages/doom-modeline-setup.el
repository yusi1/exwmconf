...
;; (doom-modeline-def-segment notmuch-unread
;;   "Displays unread emails for today using notmuch."
;;   (concat
;;    "\xf6ed "
;;    (shell-command-to-string "notmuch search -- tag:unread and tag:personal and date:today | wc -l | perl -pe 'chomp'")))

;; ;; Define your custom doom-modeline
;; (doom-modeline-def-modeline 'my-line
;;   '(bar matches buffer-info remote-host buffer-position parrot selection-info)
;;   '(misc-info minor-modes notmuch-unread input-method buffer-encoding major-mode process vcs checker))
