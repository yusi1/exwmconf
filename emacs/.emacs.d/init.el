...
(custom-set-variables
 ...
 '(package-selected-packages
   '(evil-mc evil-smartparens evil doom-modeline doom-themes elfeed wgrep wgrep-ag deft ef-themes consult-eglot eglot osm org-modern-indent org-modern notmuch-labeler highlight-indentation electric-cursor cursory all-the-icons-ibuffer diff-hl all-the-icons-dired all-the-icons ligature tempel consult-notmuch lin notmuch multiple-cursors iedit magit helpful ctrlf aggressive-indent marginalia consult pass embark which-key markdown-mode corfu sly vterm orderless vertico smartparens))
