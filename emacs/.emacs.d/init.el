...
(custom-set-variables
 ...
 '(package-selected-packages
   '(eshell-vterm gnu-elpa-keyring-update steam 2048-game bufler enwc engine-mode org-superstar command-log-mode svg-clock perspective ibuffer-projectile projectile eshell-info-banner eshell-syntax-highlighting eshell-prompt-extras desktop-environment yaml-mode pcmpl-args notmuch-bookmarks corfu-terminal corfu-doc kind-icon all-the-icons-completion mct consult-imenu flx-isearch minions avy diredfl mini-frame readline-complete company-shell evil-multiedit org-contacts evil-smartparens evil-mc crux solarized-theme solaire-mode elfeed wgrep wgrep-ag deft consult-eglot notmuch-labeler highlight-indentation electric-cursor cursory all-the-icons-ibuffer ligature lin multiple-cursors iedit ctrlf pass which-key markdown-mode smartparens))
